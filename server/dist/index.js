...
const payableRoutes_1 = __importDefault(require("./routes/payableRoutes"));
...
app.get('/api/health', async (req, res) => {
    try {
        const result = await database_1.db.query('SELECT NOW()');
...
app.use('/api/payables', payableRoutes_1.default);
// Basic route
app.get('/', (req, res) => {
